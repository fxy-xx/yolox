...
if __name__ == "__main__":
    ...
    # ----------------------------------------------------------------------------------------------------------------------------#
    model_path = 'logs/yolox-s-jiaolan.pth'
    # ------------------------------------------------------#
    ...
    #   创建yolo模型
    # ------------------------------------------------------#
    model = YoloBody(num_classes, phi, input_shape)
    weights_init(model)
    if model_path != '':
        # ------------------------------------------------------#
        #   权值文件请看README，百度网盘下载
    ...
    #   获得损失函数
    # ----------------------#
    yolo_loss = YOLOLoss(num_classes, fp16, iou_type=iou_type)
    # ----------------------#
    #   记录Loss
    # ----------------------#
    if local_rank == 0:
