...
class Encoding(nn.Module):
    ...
    def aggregate(assignment_weights, x, codewords):
        ...
        # ---开始计算eik,必须在Rei计算完之后
        m = assignment_weights * (expanded_x - reshaped_codewords)
        encoded_feat = (m).sum(1)
        return encoded_feat
